"use client"
import styles from "./PPageLoading.module.scss";
import {motion} from "framer-motion";

const PPageLoading = ({type = 'inline'}) =>{
    return (
        <div className={`${styles.wrapper} ${type === 'page' ? styles.pageType : null}`}>
            <motion.svg
                animate={{rotate: 360}}
