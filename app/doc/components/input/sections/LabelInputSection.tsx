    ...
    return (
        ...
        >
            <div className="md:w-[300px] w-full flex gap-4 flex-col">
                <BuiInput label="Email" placeholder="example@pearkit.com" onChange={() => null}/>
                <BuiInput label="Email" variant="underlined" placeholder="example@pearkit.com" onChange={() => null}/>
                <BuiInput label="Email" variant="filled" placeholder="example@pearkit.com" onChange={() => null}/>
            </div>
        </BuiComponentShowcaseArea>
    );
}
